...
const numsArray = stringsToNumbs(strNums);
console.log(numsArray);

// With the same numbers, find the sum of the even values
const sumEvens = numsArray.reduce((total, currentValue) => {
  if (currentValue % 2 === 0) {
...
const atxIdx = numsArray.findIndex((num, index) => num + index === 512);

console.log(`index: ${atxIdx}, value: ${numsArray[atxIdx]}`);
...
const idealTemp = weather.find((degree) => degree.min_temp === 15.915);
